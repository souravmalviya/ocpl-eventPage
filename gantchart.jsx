    ...
    <div data-theme={theme} style={{ background: 'var(--g-bg)', minHeight: '100vh', transition: 'background 0.3s' }}>
      <style>{`
        ...
        *, *::before, *::after { font-family: 'Inter', sans-serif; box-sizing: border-box; }
        ...
        [data-theme="dark"] {
          --g-bg:             #0c1426;
          --g-navbar-bg:      rgba(12,20,38,0.92);
          --g-navbar-bd:      rgba(255,255,255,0.1);
          --g-navbar-tx:      #e8edf8;
          --g-navbar-sub:     #8a9bb8;
          --g-toggle-bg:      #162040;
          --g-toggle-bd:      #243252;
          ...
          --g-subtitle:       #8a9aba;
          --g-container:      #121e38;
          --g-container-bd:   #2a3d5c;
          --g-header:         #0e1832;
          --g-names-bg:       #121e38;
          --g-row-odd:        #0e1832;
          --g-row-even:       #121e38;
          --g-row-hover-odd:  #162040;
          --g-row-hover-even: #1e2d4c;
          --g-week-tx:        #8aa4c8;
          --g-week-bd:        #243050;
          --g-task-tx:        #dce6f8;
          --g-heavy-bd:       #2e4268;
          --g-subtle-bd:      #1e2e48;
          --g-grid:           rgba(148,180,220,0.12);
          --g-legend:         #0e1832;
          --g-legend-tx:      #c8d5e8;
          --g-summary-bg:     #121e38;
          --g-summary-bd:     #2a3d5c;
          --g-summary-tx:     #dce6f8;
          --g-summary-lbl:    #8aa4c8;
          --g-scrollbar-tk:   #162040;
          --g-scrollbar-th:   #2a3d5c;
          --g-scrollbar-thh:  #3d5578;
        }
        [data-theme="light"] {
          --g-bg:             #eef2f7;
